          ...
          <div className={classes.container}>
            ...
            <div className={classes.account}>
              <div className={classes.accountCard}>
                ...
                <p>If your use of the Website requires an account identifying you as a user of the Website
(an ‘Account’);</p>
                <ul>
                  <li>You are solely responsible for your Account and the maintenance, confidentiality, and security of your Account and all passwords related to your Account, and any and all activities that occur under your Account, including all activities of any persons who gain access to your Account with or without your permission;</li>
                  <li>You agree to immediately notify us of any unauthorized use of your Account, any service provided through your Account or any password related to your Account, or any other breach of security with respect to your Account or any service provided through it, and you agree to provide assistance to us, as requested, to stop or remedy any breach of security related to your Account, and</li>
                  <li>You agree to provide true, current, accurate, and complete customer information as requested by us from time to time, and you agree to promptly notify us of any changes to this information as required to keep such information held by us current, complete, and accurate.</li>
                </ul>
              </div>
            </div>
            <div className={classes.payment}>
              <h1>PAYMENT</h1>
              <p>When you make a purchase on this Website, you agree to provide a valid instrument to make a payment. Pay attention to the details of the transaction, as your total price may include taxes, fees, and shipping costs, all of which you are responsible for.
...
Payment for any ongoing services is billed automatically until further notification that you would like to terminate your access to the services.</p>
            </div> 
...
You agree not to use the Website for any unlawful purpose or any purpose prohibited under this clause. You agree not to use the Website in any way that could damage the Website, the services or the general business of Moonbeam Trading Company.
...
You further agree not to use and/or access the Website:</p>    
              ...
              <div className={classes.acceptableUseBottom}>
                <div className={classes.bottomLeft}>
                  <ul>
                    ...
                    <li>To upload or otherwise disseminate computer viruses or other software that may damage the property of another;</li>
            ...
            <div className={classes.affiliateMarketing}>
              ...
              <p>We, through the Website and its services, may engage in affiliate marketing, whereby we receive a commission on or percentage of the sale of goods or services on or through the Website. We may also accept advertising and sponsorships from commercial businesses or receive other forms of advertising compensation.</p>
            </div>
            <div className={classes.privacyInfo}>
              <h1>PRIVACY INFORMATION</h1>
              <p>Through your use of the Website, you may provide us with certain information. By using the Website, you authorize us to use your information in Canada and any other country where we may operate.
...
If you would like to disable our access to any passive information we receive from the use of various technologies, you may choose to disable cookies in your web browser. Please be aware that we will receive information about you that you have provided, such as your email address.



If you choose to terminate your account, we will store information about you for a reasonable period of time to be determined by us in accordance with applicable federal and provincial laws. After this period, all information about you will be deleted.</p>
            </div>
...
For any questions, concerns, or disputes, you agree to contact us in a timely manner at the following:</p>
            ...
            <div className={classes.reverseEngineering}>
              ...
              <div className={classes.engineeringBottom}>
                <div className={classes.engineeringBottomLeft}>
                  <ul>
                    <li>Reverse engineering, or attempt to reverse engineer or disassemble any code or software from or on the Website;</li>
                  </ul>
                </div>
                <div className={classes.engineeringBottomRight}>
                  <ul>
                    <li>Violate the security of the Website through any unauthorized access, circumvention of encryption or other security tools, data mining, or interference to any host, user network.</li>
                  </ul>
                </div>
            ...
            <div className={classes.dataLoss}>
              <h1>DATA LOSS</h1>
              <p>We are not responsible for the security of your Account or Content. Your use of this Website is at your own risk.</p>
            </div>
            <div className={classes.threeColumnTwo}>
              <div className={classes.indemnification}>
                <h1>INDEMNIFICATION</h1>
                <p>You defend and indemnify Moonbeam Trading Company and any of its affiliates and hold us harmless against any and all legal claims and demands, including reasonable attorney’s fees, which may arise from or relate to your use or misuse of the Website, your breach of these Terms and Conditions, or your conduct or actions. We will select our own legal counsel and may participate in our own defence, if we wish to do so.</p>
              </div>
              ...
              <div className={classes.variation}>
                <h1>VARIATION</h1>
                <p>To the extent any part or sub-part of these Terms and Conditions is held ineffective or invalid by any court of law, the prior, effective version of these Terms and Conditions is considered enforceable and valid to the fullest extent.</p>
              </div>
            </div>
            ...
            <div className={classes.warning}>
              <div className={classes.termination}>
                ...
                <p>We may, in our sole discretion, suspend, restrict, or terminate your Account and use of the Website, effective at any time, without notice to you, for any reason, including because the operation or efficiency of the Website or our or any third party’s equipment or network is impaired by your use of the Website, any amount is past due from you to us, we have received a third party complaint which relates to your use or misuse of the Website, or you have been or are in breach of any term or condition of these Terms and Conditions. We will have no responsibility to notify any third party, including any third party providers of services, merchandise or information, of any suspension, restriction, or termination of your access to the Website.</p>
              </div>
            ...
            <div className={classes.limitation}>
              ...
              <p>We are not liable for any damages that may occur to you as a result of your use of the Website, to the fullest extent permitted by law. The maximum liability of Moonbeam Trading Company arising from your use of the Website is limited to the greater of one hundred ($100) Canadian Dollars or the amount you paid to Moonbeam Trading Company in the last six (6) months. This applies to any and all claims by you, including but not limited to lost profits or revenues, consequential or punitive damages, negligence, strict liability, fraud, or torts of any kind.</p>
            </div>
